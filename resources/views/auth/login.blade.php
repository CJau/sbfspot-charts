                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap items-center">
                            <button type="submit" class="px-4 py-2 font-bold text-gray-100 bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:ring">
                                {{ __('Login') }}
                            </button>

                            @if (Route::has('password.request'))
                                <a class="ml-auto text-sm text-blue-500 no-underline hover:text-blue-700 whitespace-nowrap" href="{{ route('password.request') }}">
