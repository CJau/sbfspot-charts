...
@section('content')
  <div class="container px-6 mx-auto md:px-0">
    ...
    @if ($data->isEmpty())
      <p class="p-4 mt-5 mb-4 bg-gray-100 shadow">No data exists for the chosen date, please use the navigation button(s) above to select a nearby day with data.</p>
    @else
